...
namespace aruna {
    namespace driver {
        namespace ADS101x {
            ...
            enum class OS {
                W_NO_EFFECT = 0b0,
                W_START_A_SINGLE_CONVERSION = 0b1,
                R_DEVICE_IS_CURRENTLY_PERFORMING_A_CONVERSION = 0b0,
                R_DEVICE_IS_NOT_CURRENTLY_PERFORMING_A_CONVERSION = 0b1,
            };
            ...
            enum class COMP_LAT {
                DEFAULT = 0b0,
                NONLATCHING_COMPARATOR = 0b0,
                LATCHING_COMPARATOR = 0b1,
            };
